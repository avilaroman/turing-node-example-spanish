        ...
        <div className="container">
          <div className="row justify-content-between">
            ...
            <div className="col-4">
              <div className="row">
                <div className="col-8">
                  <input name="search" defaultValue={search_term} type="text" className="form-control" placeholder="Buscar Producto" autoComplete="off" onChange={this.onSearchChange} />
                </div>
                <div className="col-2 p-0">
                  <button className="search-button" onClick={this.searchProduct}>Buscar</button>
                </div>
              </div>
