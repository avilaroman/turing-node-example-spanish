      ...
      case 4: {
        return (
          <div>
            ...
            <div>
              <h2>EXITOSO!</h2>
              <p>Tus ítems serán entregados pronto.</p>
              <button className="mt-4 btn" onClick={() => window.location.href="/"}>Volver a Comprar</button>
            </div>
          </div>
        )
      }
        ...
        <div className="container mt-4">
          <div className="row">
            ...
            {this.state.cartItems.length > 1 && <div className="col-6">
              <h3 className="mb-2">Items del Carrito Confirmados</h3>
